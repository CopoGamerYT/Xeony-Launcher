...
const dataPath = path.join(sysRoot, '.xeonylauncher')
...
/**
 * XEONY MOD: Función genérica para añadir cuentas (Necesaria para Offline)
 */
exports.addAuthAccount = function(uuid, accessToken, username, displayName, type = 'offline'){
    config.selectedAccount = uuid
    config.authenticationDatabase[uuid] = {
        type: type,
        accessToken,
...
/**
 * XEONY MOD: Getters y Setters genéricos para el bloqueo de 30 días
 */
